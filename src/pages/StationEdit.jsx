...
export function StationEdit({ show, onClose, station, onSave, onUploaded = null }) {
                ...
                <div className="body-edit-modal">
                    <div className="image-station">
                        <button className="image-container" onClick={() => fileInputRef.current.click()}>
                            {imgUrl ? <img src={imgUrl} alt="Station" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : <Thumbnail />}
                            <input 
                                type="file" 
                                ref={fileInputRef}
                                style={{ display: 'none' }} 
